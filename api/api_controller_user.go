...
func (api *APIController) UserGetByUsername(ctx context.Context, username string) (item *models.UserSpecData, err error) {
...
func (api *APIController) UserLogin(
	...
	username string,
	password string,
) (item *models.UserSpecData, tokens *models.Tokens, err error) {
	clog := log.WithContext(ctx).WithFields(log.Fields{
